...
(
    ...
    CONSTRAINT ue_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT fk_film_film_directors FOREIGN KEY (film_id) REFERENCES films (film_id) ON DELETE CASCADE,
    CONSTRAINT fk_genre_film_directors FOREIGN KEY (director_id) REFERENCES directors (director_id) ON DELETE CASCADE
);